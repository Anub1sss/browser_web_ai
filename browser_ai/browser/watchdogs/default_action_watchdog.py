...
from browser_ai.actor.utils import get_key_info
...
from browser_ai.browser.views import BrowserError, URLNotAllowedError
...
class DefaultActionWatchdog(BaseWatchdog):
	...
	async def _handle_print_button_click(self, element_node: EnhancedDOMTreeNode) -> dict | None:
		...
		try:
			...
			from browser_ai.browser.events import FileDownloadedEvent
