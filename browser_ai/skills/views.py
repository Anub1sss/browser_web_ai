...
from browser_ai_sdk.types.parameter_schema import ParameterSchema
from browser_ai_sdk.types.skill_response import SkillResponse
...
class Skill(BaseModel):
	...
	def parameters_pydantic(self, exclude_cookies: bool = False) -> type[BaseModel]:
		...
		"""
		from browser_ai.skills.utils import convert_parameters_to_pydantic
	...
	def output_type_pydantic(self) -> type[BaseModel] | None:
		...
		from browser_ai.skills.utils import convert_json_schema_to_pydantic
